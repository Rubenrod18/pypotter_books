...
class BookSeedFactory(BaseSeedFactory):
    class Meta:
        model = Book
...
class HarryPotterPartOneBookSeedFactory(BookSeedFactory):
...
class HarryPotterPartTwoBookSeedFactory(BookSeedFactory):
...
class HarryPotterPartThreeBookSeedFactory(BookSeedFactory):
...
class HarryPotterPartFourBookSeedFactory(BookSeedFactory):
...
class HarryPotterPartFiveBookSeedFactory(BookSeedFactory):
